...
/*
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void checkForCamaraWritePermissionss(final FragmentActivity activity, WorkFinish workFinish) {
        List<String> permissionsNeeded = new ArrayList<String>();
        final List<String> permissionsList = new ArrayList<String>();
        if (!addPermission(permissionsList, Manifest.permission.CAMERA, activity))
            permissionsNeeded.add("CAMERA");
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public static void checkForCamaraWritePermissions(final android.app.Fragment fragment, WorkFinish workFinish) {
        List<String> permissionsNeeded = new ArrayList<String>();
        final List<String> permissionsList = new ArrayList<String>();
