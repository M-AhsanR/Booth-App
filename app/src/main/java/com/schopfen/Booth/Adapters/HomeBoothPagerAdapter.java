...
public class HomeBoothPagerAdapter extends PagerAdapter {
    ...
    public HomeBoothPagerAdapter(Context context, ArrayList<ProductImagesData> productImagesData, String videoURL, String videothumbnail) {
    ...
    public HomeBoothPagerAdapter(Context context, ArrayList<ProductImagesData> productImagesData) {
        this.context = context;
        this.layoutInflater = (LayoutInflater) this.context.getSystemService(this.context.LAYOUT_INFLATER_SERVICE);
        this.productImagesData = productImagesData;
    }
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.e("ImgTag", String.valueOf(img.getTag()));
                    ...
                    mEditor.putString("ProductID", AdapterMainActivityHomeBooth.products.get(Integer.parseInt(String.valueOf(img.getTag()))).getProductID()).apply();
