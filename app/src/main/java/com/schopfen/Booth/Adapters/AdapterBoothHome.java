...
public class AdapterBoothHome extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static int nextLike;

    public AdapterBoothHome(Context mContext, ArrayList<ProductsData> Product, CRLCallbacks callbacks) {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int i) {
        ...
        switch (type) {
            case "0":
                ...
                ((MyViewHolder) holder).comment_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (products.get(i).getType().equals("0")) {
                            ...
                            mEditor.putString("QuestionID", products.get(i).getQuestionID()).apply();
                            mContext.startActivity(intent);
                        } else if (products.get(i).getType().equals("1")) {
                            Home_Home_Fragment.refreshposition = i;
                            Home_Home_Fragment.refresh = true;
                            Intent intent = new Intent(mContext, ProductDetailsActivity.class);
                            mEditor.putString("ProductID", products.get(i).getProductID()).apply();
                            mContext.startActivity(intent);
                        }
                    }
                });
                ...
                ((MyViewHolder) holder).quesUserImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ...
                        ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) mContext,
                                ((MyViewHolder) holder).quesUserImage,
                                ViewCompat.getTransitionName(((MyViewHolder) holder).quesUserImage));
...
//                ((MyViewHolder1) holder).viewpagerContainer.setLayoutParams(lp);

                ((MyViewHolder1)holder).blurring.setVisibility(View.VISIBLE);
                BoothHomePagerAdapter BoothHomePagerAdapter;
                if (products.get(i).getProductVideo().equals("")){
                    BoothHomePagerAdapter = new BoothHomePagerAdapter(mContext, products.get(i).getProductImagesData());
                }else {
                    products.get(i).getProductImagesData().add(new ProductImagesData("", ""));
                    BoothHomePagerAdapter = new BoothHomePagerAdapter(mContext, products.get(i).getProductImagesData(), products.get(i).getProductVideo(), products.get(i).getProductVideoThumbnail());
                }
...
//                ((MyViewHolder1)holder).viewPager.setOffscreenPageLimit(2);
                ...
                BoothHomePagerAdapter.notifyDataSetChanged();
                ((MyViewHolder1) holder).viewPager.setAdapter(BoothHomePagerAdapter);
                ...
                for (int j = 0; j < products.get(i).getProductImagesData().size(); j++) {
                    imageViewerArray.add(products.get(i).getProductImagesData().get(j).getProductCompressedImage());
                }
                ((MyViewHolder1) holder).viewPager.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        new ImageViewer.Builder(mContext, imageViewerArray)
                                .setStartPosition(0)
                                .show();
                    }
                });

                ((MyViewHolder1) holder).likeIcon.setEnabled(false);
                ...
                /*((MyViewHolder1) holder).commentsCountLinear.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (products.get(i).getType().equals("0")) {
                            ...
                            bundle.putSerializable("IMAGESARRAY", products.get(i).getProductImagesData());
                            bundle.putString("IMAGE", products.get(i).getBoothImage());
                            bundle.putString("NAME", products.get(i).getUserName());
                            bundle.putString("CITY", products.get(i).getCityName());
                            bundle.putString("TIME", products.get(i).getCreatedAt());
                            bundle.putString("DESCRIPTION", products.get(i).getProductDescription());
                            bundle.putString("COMENTSCOUNT", products.get(i).getCommentCount());
                            bundle.putString("USERID", products.get(i).getUserID());
...
//                if (!Home_Home_Fragment.promotedProductsData.isEmpty()) {
//                    HomeHomePromotedAdapter cateViewPagerAdapter = new HomeHomePromotedAdapter("BoothHome", mContext, Home_Home_Fragment.promotedProductsData);
//                    ((HeaderViewHolder) holder).viewPager.setClipToPadding(false);
////                                viewPager.setOffscreenPageLimit(2);
//                    ((HeaderViewHolder) holder).viewPager.setPadding(0, 0, 0, 0);
//                    ((HeaderViewHolder) holder).viewPager.setPageMargin(0);
//                    ((HeaderViewHolder) holder).viewPager.setAdapter(cateViewPagerAdapter);
//                } else {
...
//        body.put("OS", Build.VERSION.RELEASE);
    ...
    class MyViewHolder1 extends RecyclerView.ViewHolder {
        ...
        LinearLayout linearLayout, commentsCountLinear, addToCart, productShareBtn, blurring;
        ...
        MyViewHolder1(View itemView) {
            ...
            blurring = itemView.findViewById(R.id.blurring);
            addToCart = itemView.findViewById(R.id.addToCart);
            productShareBtn = itemView.findViewById(R.id.productShareBtn);
//            viewpagerContainer = itemView.findViewById(R.id.viewpagerContainer);
        }
    }
