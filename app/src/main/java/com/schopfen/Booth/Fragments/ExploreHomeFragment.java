...
import com.schopfen.Booth.Activities.ExploreAppActivity;
...
//                                mEditor.putString("ProductID",ProductID).commit();
                            ...
                            homeCateRecyclAdapter = new AdapterMainActivity("Explore", getContext(), productsData, new AdapterMainActivity.CRLCallbacks() {
                                @Override
